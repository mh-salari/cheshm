...
#include "cheshm/limbus/Daugman/integro_differential/defaults.hpp"
#include "cheshm/limbus/Daugman/integro_differential/operator.hpp"
...
NB_MODULE(_core, m)
{
    ...
    m.def(
        "detect_limbus", &detect_limbus, "img"_a, "seed_x"_a, "seed_y"_a, "r_min"_a, "r_max"_a, "range_"_a, "step"_a);
