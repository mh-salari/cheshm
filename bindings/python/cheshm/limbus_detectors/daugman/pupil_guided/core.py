...
_UI = {
    ...
    "k_min": {"min": 0.1, "max": 20.0, "help": "Lower radius factor: search starts at k_min · pupil_radius(θ)."},
    "k_max": {"min": 0.1, "max": 20.0, "help": "Upper radius factor: search ends at k_max · pupil_radius(θ)."},
}
