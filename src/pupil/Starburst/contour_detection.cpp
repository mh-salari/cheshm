...
int RansacEllipse::starburst_pupil_contour_detection(std::uint8_t* pupil_image,
                                                     ...
                                                     int minimum_candidate_features)
{
    ...
    while (edge_thresh > 5 && loop_count <= 10)
    {
        ...
        for (int i = 0; i < first_ep_num; i++)
        {
            ...
            locate_edge_points(pupil_image,
                               width,
                               height,
                               edge->x,
                               edge->y,
...
void RansacEllipse::locate_edge_points(const std::uint8_t* image,
                                       int width,
                                       int height,
                                       double cx,
                                       double cy,
                                       ...
                                       int edge_thresh)
{
    ...
    for (double angle = angle_normal - angle_spread / 2 + 0.0001; angle < angle_normal + angle_spread / 2;
         angle += angle_step)
    {
