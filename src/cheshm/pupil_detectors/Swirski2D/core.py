...
def detect_pupil(
    ...
    *,
    radius_min: int = _core.RADIUS_MIN,
    radius_max: int = _core.RADIUS_MAX,
    canny_blur: float = _core.CANNY_BLUR,
    canny_threshold_1: float = _core.CANNY_THRESHOLD_1,
    canny_threshold_2: float = _core.CANNY_THRESHOLD_2,
    starburst_points: int = _core.STARBURST_POINTS,
    percentage_inliers: int = _core.PERCENTAGE_INLIERS,
    inlier_iterations: int = _core.INLIER_ITERATIONS,
    image_aware_support: bool = _core.IMAGE_AWARE_SUPPORT,
    early_termination_percentage: int = _core.EARLY_TERMINATION_PERCENTAGE,
    early_rejection: bool = _core.EARLY_REJECTION,
    seed: int = _core.SEED,
    max_inliers: int = _core.MAX_INLIERS,
) -> PupilResult | None:
