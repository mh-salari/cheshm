...
{
    return detail::filter_helper<Container, Function>::filter(std::forward<Function>(func),
                                                              std::forward<Container>(src));
}
...
/*namespace internal {
    ...
    return internal::reduce_helper<Container, Function>::reduce(std::forward<Function>(func),
   std::forward<Container>(src));
    }
    template<class Container, class Function>
    typename internal::reduce_helper<Container, Function>::acc_type reduce(Function func, Container src, typename
   std::result_of<Function>::type init) { return internal::reduce_helper<Container,
   Function>::reduce(std::forward<Function>(func), std::forward<Container>(src), std::move(init));
    }*/
