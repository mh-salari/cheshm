...
public:
    ...
    int starburst_pupil_contour_detection(std::uint8_t* pupil_image,
    ...
    int* pupil_fitting_inliers(std::uint8_t* pupil_image, int width, int height, int& return_max_inliers_num);
